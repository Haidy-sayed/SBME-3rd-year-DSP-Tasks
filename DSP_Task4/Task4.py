...
#        self.CurveFittingGraph.
    ...
    def errorMap(self, errorVals):
      ...
      #  for k in range(0, self.InterpolationOrder):
       #     self.arr.append(errorVals)
        ...
        #errFig=plt.imshow(self.arr, cmap='inferno', interpolation='none',aspect='auto')
    ...
    def split_into_chunks(self):
      ...
      #  for l in range(self.numChunks):
       #     for iterator in range(int(1000/self.numChunks)):
        #        print(self.feature_chunks[l][iterator])
    ...
    def perform_interpolation(self,degree):
      ...
      #  for i in range(self.numChunks):
       #     for j in range(int(1000/self.numChunks)):
        #        while(k<1000):
         #           self.calculated_chunks[i][j]=self.y_axis[k]
          #      k+=1
           # print(self.calculated_chunks[i])
