...
#        self.get_stats2(time2,amp2)

 #       return self.time2,self.amp2
   ...
   #     self.get_stats3(self.time3,self.amp3)
    ...
    def get_stats(self,time,amp):
        print('yooooooo')    
        #duration=time[-1]
      #  max_amp = statistics.max(amp)
        
       # min_amp = statistics.min(amp)
    ...
    def get_stats2(self,time,amp):
        ...
        mean_amp = statistics.mean(amp)
        std_amp = statistics.stdev(amp)
        stats2=[duration,max_amp,min_amp,mean_amp,std_amp] 
        return stats2    
...
#         exporter.export('summary photo.png')
#         
# =============================================================================
        try:
...
#         pdf.cell(40,10,"Signal Viewer - Summary & statistics",ln=True,border=0)
#         
#         pdf.output('cry.pdf')
#                 
# 
...
# 
#         pdf.set_font('helvetica','B',16)
#         pdf.cell(40,10,"Signal Viewer Statistics & Summary",ln=True,border=1)
# 
#         pdf.set_font('helvetica','',14)
#         pdf.cell(40,10,"I've got chlamedia",ln=True)
#         
#         for i in range(30):
#            pdf.set_font('helvetica','',14)
#            pdf.cell(40,10,"{}".format(i),ln=True)
#     
#         pdf.output('yaaaaa.pdf')
# =============================================================================
