...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        #Our plotting widget
        self.graphCh1=pyqtgraph.GraphicsLayoutWidget(self.centralwidget)
        ...
        self.menuOpen_Ch3 = QtWidgets.QAction(mainWindow)
        self.menuOpen_Ch3.setObjectName("menuOpen_Ch3")
        ...
        self.menuOpen.addAction(self.menuOpen_Ch3)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.menuOpen_Ch3.setText(_translate("mainWindow", "Channel 3"))
        ...
        self.menuOpen_Ch1.triggered.connect(lambda: self.open_file())
        self.menuOpen_Ch2.triggered.connect(lambda: self.open_file2())
        self.menuOpen_Ch3.triggered.connect(lambda: self.open_file3())
        ...
        self.stopButtonCh1.clicked.connect(lambda: self.clear())
       # self.stopButtonCh2.clicked.connect(lambda: self.stop())
...
# =============================================================================
#         self.compareButtonCh1.clicked.connect(lambda: self.open_file("ch1"))
#         self.compareButtonCh2.clicked.connect(lambda: self.open_file2("ch2"))
# =============================================================================
    ...
    def read_data2(self,file_name):
        ...
        self.draw2(time2,amp2,self.color2)
    ...
    def read_data3(self,file_name):
        ...
        self.draw3(time3,amp3,self.color3)
 ...
 #       self.p1.setLimits(xMin=0)
        ...
        self.curve1.setData(self.time[self.index:self.index+500], self.amp[self.index:self.index+500], pen=pen)
        self.timer1.setInterval(100)
        self.timer1.timeout.connect(lambda:self.update_plot_data(self.time,self.amp))
        self.timer1.start()
                            

    def draw2(self,time2,amp2,color2):
        """sets up our canvas to plot"""
        self.time2 = time2
        self.amp2=amp2
        self.index2=0  
        pen = pyqtgraph.mkPen(color2) #signal color
        self.curve2.setData(self.time2[self.index2:self.index2+500], self.amp2[self.index2:self.index2+500], pen=pen)
        self.timer1.setInterval(100)
        self.timer1.timeout.connect(lambda:self.update_plot_data2(self.time2,self.amp2))
        self.timer1.start()

    def draw3(self,time3,amp3,color3):
        """sets up our canvas to plot"""
        self.time3 = time3
        self.amp3=amp3
        self.index3=0  
        pen = pyqtgraph.mkPen(color3) #signal color
