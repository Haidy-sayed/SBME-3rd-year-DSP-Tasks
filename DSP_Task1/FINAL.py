...
class Ui_MainWindow(object):
  ...
  #      self.max_x_limit=100
        ...
        self.timerInterval2 = 400
        self.timerInterval3 = 400
    ...
    def draw2(self,time,amp,color):
        ...
        self.timer2.setInterval(self.timerInterval2)
    ...
    def draw3(self,time,amp,color):
        ...
        self.timer3.setInterval(self.timerInterval3)
    ...
    def slow(self,channel):
        if channel== "Ch1":
            ...
            self.timerInterval2 = self.timerInterval2 * 2
            self.timer2.setInterval(self.timerInterval2)
        else:
            self.timerInterval3 = self.timerInterval3 * 2
            self.timer3.setInterval(self.timerInterval3)
